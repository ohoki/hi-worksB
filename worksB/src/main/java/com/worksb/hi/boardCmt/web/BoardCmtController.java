...
public class BoardCmtController {
	...
	// 댓글 목록
	@GetMapping("/member/boardCmtList")
	@ResponseBody
    ...
    // 댓글 등록
	@PostMapping("/member/boardCmtInsert")
	@ResponseBody
	...
	// 댓글 수정
	@PostMapping("/member/boardCmtUpdate")
	@ResponseBody
	...
	@PostMapping("/member/boardCmtDelete")
	@ResponseBody
	...
	@PostMapping("/member/realCmtDelete")
	@ResponseBody
