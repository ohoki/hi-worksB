...
<body>
	...
	<div class="notice-insert-box">
		...
		<form action="${pageContext.request.contextPath}/admin/noticeUpdate" method="post">
			<input type="text" id="noticeTitle" name="noticeTitle" value="${noticeInfo.noticeTitle }">
